...
| E2E / helper E2E — ubuntu-latest                 | Elevated helper-copy test                          | Same E2E triggers                    | Runs when `updater` is true; helper source is part of updater-impacting paths                    |     | E2E / updater E2E — `<browser>` — `<os>` | Updater tests: Firefox stable + Dev Edition (hard gate) | Same E2E triggers | Runs when `updater` is true |
